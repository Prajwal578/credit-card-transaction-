...
-- https://www.kaggle.com/datasets/thedevastator/analyzing-credit-card-spending-habits-in-indiacredit_card_transcations
...
use test;
select*from test.credit_card_transcations;
WITH cte1 as(
	SELECT city, SUM(amount) as total_spend
	FROM test.credit_card_transcations
	GROUP BY city
), cte2 as(
